...
export default function TermsOfUse() {
  ...
  const sections = [
    ...
    { id: "acceptance", title: t("acceptance.title"), content: t("acceptance.content") },
    { id: "services", title: t("services.title"), content: t("services.content") },
    { id: "ip", title: t("ip.title"), content: t("ip.content") },
    { id: "user-conduct", title: t("conduct.title"), content: t("conduct.content") },
    { id: "disclaimer", title: t("disclaimer.title"), content: t("disclaimer.content") },
    { id: "liability", title: t("liability.title"), content: t("liability.content") },
    { id: "governing-law", title: t("governingLaw.title"), content: t("governingLaw.content") },
