...
export default function PrivacyPolicy() {
  ...
  const sections = [
    ...
    { id: "collection", title: t("collection.title"), content: t("collection.content") },
    { id: "usage", title: t("usage.title"), content: t("usage.content") },
    { id: "protection", title: t("protection.title"), content: t("protection.content") },
    { id: "rights", title: t("rights.title"), content: t("rights.content") },
    { id: "cookies", title: t("cookies.title"), content: t("cookies.content") },
